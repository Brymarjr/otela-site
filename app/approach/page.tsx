    ...
    <>
      <section className="pb-6 pt-16 md:pt-24">
        <div className="max-w-[1120px] mx-auto px-8">
          <p className="text-slate text-[0.95rem] mb-3.5 tracking-wide uppercase font-medium">Approach</p>
      ...
      <section className="bg-ink text-white py-16 md:py-24">
        <div className="max-w-[1120px] mx-auto px-8">
          <div className="max-w-[60ch]">
            <p className="text-brass-dark text-[0.95rem] mb-2 tracking-wide uppercase font-medium">On confidentiality</p>
